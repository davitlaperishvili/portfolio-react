    ...
    return (
        <div className="content contact">
            ...
            <div className="contact_info">
                ...
                <ul>
                    <li>
                    <a target="__blank" href="https://www.facebook.com/dato.laperishvili/">
                        <FontAwesomeIcon icon={faFacebookSquare} />
                    </a>
                    </li>
                    <li>
                    <a target="__blank" href="https://www.linkedin.com/in/davit-laperishvili-964511175/">
                        <em className="fab fa-linkedin"></em>
                        <FontAwesomeIcon icon={faLinkedinIn} />
                    </a>
                    </li>
                    <li>
                    <a target="__blank" href="https://www.instagram.com/davitlaperishvili/">
