const projects = [
    ...
    },
    {
        ...
        <div class="project_desc">
            <div class="project_name">kandinsky.media</div>
            <div class="project_text">
                <p>Web Site for Russian Flower shop</p>
                <p>Site was created by using twig as a front-end and opencart as a backend.</p>
                <p>In this project I was a Front-end developer. I developed markup structure and JS animations.</p>
                <span>Team:</span>
                <ul>
                    <li>Front-end developer</li>
                    <li>Beck-end developer</li>
